...
def analyze_telemetry(data_24h, weekly_stats, system_name, metadata, user_query):
...
Recent telemetry records (last 24h sample):
{recent_snippet}

User query: {user_query}

Please analyze the data and answer the user's question specifically. Provide insights, highlight patterns, anomalies, or concerns relevant to the query.
"""
